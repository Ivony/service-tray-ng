...
public static class Strings
{
    ...
    private static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        ["Dialog.Exit.Title"] = "Stopping services",
        ["Dialog.Exit.Starting"] = "Stopping services...",
        ["Dialog.Exit.Preparing"] = "Preparing to exit...",
        ["Dialog.Exit.Progress"] = "Stopping service {0} of {1}",
        ["Dialog.Exit.Pending"] = "Pending",
        ["Dialog.Exit.InProgress"] = "Stopping...",
        ["Dialog.Exit.Completed"] = "Stopped",
        ["Dialog.Exit.Failed"] = "Failed",
        ["Dialog.Exit.Finished"] = "All shutdown tasks completed.",
        ["Dialog.Exit.FinishedWithFailures"] = "Shutdown completed with {0} failed task(s).",
    ...
    private static readonly IReadOnlyDictionary<string, string> Zh = new Dictionary<string, string>
    {
        ...
        ["Dialog.Exit.Title"] = "正在停止服务",
        ["Dialog.Exit.Starting"] = "正在停止服务...",
        ["Dialog.Exit.Preparing"] = "正在准备退出...",
        ["Dialog.Exit.Progress"] = "正在停止第 {0} / {1} 个服务",
        ["Dialog.Exit.Pending"] = "等待中",
        ["Dialog.Exit.InProgress"] = "停止中...",
        ["Dialog.Exit.Completed"] = "已停止",
        ["Dialog.Exit.Failed"] = "失败",
        ["Dialog.Exit.Finished"] = "退出任务已完成。",
        ["Dialog.Exit.FinishedWithFailures"] = "退出完成，但有 {0} 个任务失败。",
